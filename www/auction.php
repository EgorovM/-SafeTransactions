...
?>
		<div class = "container handheld_mode">
				...
				<div class = "col s12">
					<div class="card">
						...
						<div class="card-reveal">
							...
							<hr>
							<p><font class = "grey-text">Своя стоимость:</font> 300 рб</p>
							<p><font class = "grey-text">Начальная цена:</font> 200 рб</p>
						</div>
					</div>
				</div>
				<div class = "col s12">
					<div class="card">
						...
						<div class="card-reveal">
							...
							<hr>
							<p><font class = "grey-text">Своя стоимость:</font> 150 рб</p>
							<p><font class = "grey-text">Начальная стоимость:</font> 100 рб</p>
				...
				<div class = "col s12">
					<div class="card">
						...
						<div class="card-reveal">
							...
							<hr>
							<p><font class = "grey-text">Своя стоимость:</font> 425 рб</p>
							<p><font class = "grey-text">Начальная стоимость:</font> 350 рб</p>
						</div>
					</div>
				</div>
			</div>
